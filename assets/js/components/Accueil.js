        ...
        <div className="row justify-content-md-center">
          <div className="cadreSombre">
            ...
            <div className="accueilContenu">
              ...
              <p>
                Ses actions : projets internationaux (aussi scolaires, maison de
                jeunes, scouts en Amérique de sud, Afrique et Asie). Projet
                alternative locales. Animations pédagogiques (Jeu de la ficelle,
                Potentia, Jeu des chaises, Dezobeyi...). Mobilisations.
              </p>
              <h4>
                <u>
                  <b>Jeu Dezobeyi :</b>
              ...
              <p>
                ...
                l'action directe non-violente est (et a toujours été) un levier
                de changement social. Droit de vote des femmes, abolition de la
                ségrégation, récupération de terres... : tous ont été obtenus
                notamment par des actions de "désobéissance".
              </p>
              <p>
